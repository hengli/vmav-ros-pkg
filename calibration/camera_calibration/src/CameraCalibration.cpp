...
void
CameraCalibration::writeParameters(const std::string& filename) const
{
    m_camera->writeParametersToYamlFile(filename);
}

void
CameraCalibration::writeParameters(px_comm::CameraInfoPtr& cameraInfo) const
{
    m_camera->writeParameters(cameraInfo);
}
...
bool
CameraCalibration::writeChessboardData(std::ofstream& ofs) const
{
...
bool
CameraCalibration::readChessboardData(std::ifstream& ifs)
{
