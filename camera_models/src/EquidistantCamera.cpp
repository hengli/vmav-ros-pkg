...
void
EquidistantCamera::setZeroDistortion(void)
{
...
void
EquidistantCamera::readParameters(const px_comm::CameraInfoConstPtr& cameraInfo)
{
    ...
    params.k2() = cameraInfo->P.at(0);
    params.k3() = cameraInfo->P.at(1);
    params.k4() = cameraInfo->P.at(2);
    params.k5() = cameraInfo->P.at(3);
    params.mu() = cameraInfo->P.at(4);
    params.mv() = cameraInfo->P.at(5);
    params.u0() = cameraInfo->P.at(6);
    params.v0() = cameraInfo->P.at(7);
...
EquidistantCamera::fitCircle(const std::vector<cv::Point2d>& points,
                             double& centerX, double& centerY, double& radius) const
{
